...
exports.getEmployeeForAssignment = exports.getEmployee = exports.createEmployee = void 0;
...
;
function getEmployeeForAssignment(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        // Return deatils of all employee of that location
        if (req.query.location) {
            const response = yield (0, employeeModel_1.readEmployeeForAssignment)(req.query.location);
            return res.status(response.code).send(response.data);
        }
        else {
            console.log("No location provided");
            return res.status(httpStatusCodes_1.HttpStatus.INTERNAL_SERVER_ERROR).send({ 'msg': "ERRROROROR" });
        }
    });
}
exports.getEmployeeForAssignment = getEmployeeForAssignment;
;
